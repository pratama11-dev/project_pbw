        ...
        <div className="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
          <div id="kt_header_menu" className="header-menu header-menu-mobile header-menu-layout-default">
            <ul className="menu-nav">
              <li className="menu-item menu-item-submenu menu-item-rel menu-item-active" data-menu-toggle="click" aria-haspopup="true">
                ...
                <div className="menu-submenu menu-submenu-classNameic menu-submenu-left">
                  <ul className="menu-subnav">
                    ...
                    <li className="menu-item" aria-haspopup="true">
                      <a href="#" className="menu-link">
                        ...
                        <span className="menu-label">
                          <span className="label label-success label-rounded">2</span>
                        </span>
                      </a>
                    </li>
                        ...
                        <ul className="menu-subnav">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Edit Team Member</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Delete Team Member</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Team Member Reports</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Promote Team Member</span>
                            </a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <li className="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                      <a href="/metronic/demo1/#.html" className="menu-link menu-toggle">
                        <span className="svg-icon menu-icon">
                          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                              <rect x="0" y="0" width="24" height="24"></rect>
                        ...
                        <ul className="menu-subnav">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Ongoing Projects</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Completed Projects</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Dropped Projects</span>
                            </a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <ul className="menu-content">
                        ...
                        <ul className="menu-inner">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Year to Date Reports</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Quarterly Profits</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                        ...
                        <ul className="menu-inner">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Project Managers</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Development Staff</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Sales and Marketing</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                      ...
                      <li className="menu-item">
                        ...
                        <ul className="menu-inner">
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              <span className="menu-text">Analytical Reports</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              <span className="menu-text">Operational Growth</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              <span className="menu-text">Social Media Presence</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              <span className="menu-text">Files and Directories</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                  ...
                  <ul className="menu-subnav">
                        ...
                        <ul className="menu-subnav">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">User Dropout Points</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                          ...
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Opportunity Growth</span>
                            </a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <li className="menu-item" aria-haspopup="true">
                      <a href="#" className="menu-link">
                        ...
                        <span className="menu-label">
                          <span className="label label-success label-rounded">3</span>
                        </span>
                      </a>
                    </li>
                    <li className="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                        ...
                        <ul className="menu-subnav">
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-label">
                                <span className="label label-danger label-rounded">3</span>
                              </span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Version Controls</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
                              ...
                              <span className="menu-text">Database Manager</span>
                            </a>
                          </li>
                          <li className="menu-item" aria-haspopup="true">
                            <a href="#" className="menu-link">
