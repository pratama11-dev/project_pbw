			...
			<div className="d-flex flex-row flex-column-fluid page">
				<div className="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					<div className="brand flex-column-auto" id="kt_brand">
						<a href="/metronic/demo1/index.html" className="brand-logo">
							<img alt="Logo" src="https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/logos/logo-light.png" />
						</a>
