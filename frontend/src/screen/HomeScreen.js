                        ...
                        <div className="card-body p-0 d-flex rounded bg-light-success">
                          <div className="py-18 px-12">
                            <h3 className="font-size-h1">
                              <a href="#" className="text-dark font-weight-bolder">Nike Sneakers</a>
                            </h3>
                            <div className="font-size-h4 text-success">Get Amazing Nike Sneakers</div>
                          </div>
                          <div className="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-cover" style={{transform: "scale(1.5) rotate(-26deg)", backgroundImage: "url('https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/products/13.png')"}}></div>
                        </div>
                      </div>
                      <div className="card card-custom card-stretch card-stretch-half gutter-b overflow-hidden">
                        <div className="card-body p-0 d-flex rounded bg-light-danger">
                          <div className="py-18 px-12">
                            <h3 className="font-size-h1">
                              <a href="#" className="text-dark font-weight-bolder">Nike Sneakers</a>
                            </h3>
                            <div className="font-size-h4 text-danger">Get Amazing Nike Sneakers</div>
                          </div>
                          <div className="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-cover" style={{transform: "scale(1.5) rotate(-26deg)", backgroundImage: "url('https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/products/12.png')"}}></div>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-4 col-lg-12 col-xxl-4">
                      <div className="card card-custom card-stretch gutter-b">
                        <div className="card-body d-flex flex-column rounded bg-light-primary justify-content-between">
                          <div className="rounded text-center mb-7 pt-7">
                            <img src="https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/products/14.png" className="mw-100 w-200px" style={{transform: "scale(1.4)"}} />
                          </div>
                  ...
                  <div className="row">
                      ...
                      <div className="card card-custom gutter-b card-stretch">
                        <div className="card-body d-flex flex-column rounded bg-light justify-content-between">
                          <div className="text-center rounded mb-7">
                            <img src="https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/products/15.png" className="mw-100 w-200px"/>
                          </div>
                          <div>
                            <h4 className="font-size-h5">
                              <a href="#" className="text-dark-75 font-weight-bolder">Bose Headphones 700</a>
                            </h4>
                            <div className="font-size-h6 text-muted font-weight-bolder">$370.00</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-4 col-lg-12 col-xxl-4">
                      <div className="card card-custom gutter-b card-stretch">
                        <div className="card-body d-flex flex-column rounded bg-light justify-content-between">
                          <div className="text-center rounded mb-7">
                            <img src="https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/products/16.png" className="mw-100 w-200px"/>
                          </div>
                          <div>
                            <h4 className="font-size-h5">
                              <a href="#" className="text-dark-75 font-weight-bolder">Amazon Bip Home</a>
                            </h4>
                            <div className="font-size-h6 text-muted font-weight-bolder">$370.00</div>
                          </div>
                        </div>
                    ...
                    <div className="col-md-4 col-lg-12 col-xxl-4">
                      <div className="card card-custom gutter-b card-stretch">
                        <div className="card-body d-flex flex-column rounded bg-light justify-content-between">
                          <div className="text-center rounded mb-7">
                            <img src="https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/products/17.png" className="mw-100 w-200px"/>
                          </div>
                          <div>
                            <h4 className="font-size-h5">
                              <a href="#" className="text-dark-75 font-weight-bolder">Black &amp; White Vases</a>
                            </h4>
                            <div className="font-size-h6 text-muted font-weight-bolder">$370.00</div>
                          </div>
                        </div>
                    ...
                    <div className="col-md-4 col-lg-12 col-xxl-4">
                      <div className="card card-custom gutter-b card-stretch">
                        <div className="card-body d-flex flex-column rounded bg-light justify-content-between">
                          <div className="text-center rounded mb-7">
                            <img src="https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/products/18.png" className="mw-100 w-200px"/>
                          </div>
                          <div>
                            <h4 className="font-size-h5">
                              <a href="#" className="text-dark-75 font-weight-bolder">Spine Friendly Chair</a>
                            </h4>
                            <div className="font-size-h6 text-muted font-weight-bolder">$370.00</div>
                          </div>
                        </div>
                    ...
                    <div className="col-md-4 col-lg-12 col-xxl-4">
                      <div className="card card-custom gutter-b card-stretch">
                        <div className="card-body d-flex flex-column rounded bg-light justify-content-between">
                          <div className="text-center rounded mb-7">
                            <img src="https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/products/19.png" className="mw-100 w-200px"/>
                          </div>
                          <div>
                            <h4 className="font-size-h5">
                              <a href="#" className="text-dark-75 font-weight-bolder">Yellow Kettle</a>
                            </h4>
                            <div className="font-size-h6 text-muted font-weight-bolder">$370.00</div>
                          </div>
                        </div>
                    ...
                    <div className="col-md-4 col-lg-12 col-xxl-4">
                      <div className="card card-custom gutter-b card-stretch">
                        <div className="card-body d-flex flex-column rounded bg-light justify-content-between">
                          <div className="text-center rounded mb-7">
                            <img src="https://metronic-assets.s3-ap-southeast-1.amazonaws.com/media/products/20.png" className="mw-100 w-200px"/>
                          </div>
                          <div>
                            <h4 className="font-size-h5">
                              <a href="#" className="text-dark-75 font-weight-bolder">Amazing Mats</a>
                            </h4>
                            <div className="font-size-h6 text-muted font-weight-bolder">$370.00</div>
                          </div>
                        </div>
